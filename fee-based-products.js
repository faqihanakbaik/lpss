...
// Total: 11 Products (Sesuai kategori Fee Based Income Layanan)

console.log("📦 Loading fee-based-products.js...");
...
const feeBasedProducts = [
  ...
  // 3. PAYROLL
  {
    ...
    details: {
      ...
      tarif:
        "Saldo Awal: Berdasarkan Gaji. Biaya Payroll: 20 - < 25 pegawai: Rp 2.000, > 25 pegawai: Gratis. Biaya Cetak Laporan Keuangan: Rp 10.000-Rp 25.000",
    },
  },
  ...
  // 4. KIRIMAN UANG MELALUI SKNBI
  {
    ...
    details: {
      ...
      fitur:
        "Layanan transfer antarbank berbasis syariah. Adanya imbalan jasa (ujrah) yang sah dan disepakati. Efisiensi biaya (lebih murah dari RTGS). Cocok untuk nominal menengah (hingga Rp 1 M). Transaksi dilakukan dengan prinsip kepercayaan (wakalah) antara nasabah dan bank.",
      tarif:
        "Biaya kiriman uang SKNBI (non-RTGS): Rp 2.900. Layanan Kliring Warkat Debit sebesar Rp 5.000/DKE. Layanan Pembayaran Reguler sebesar Rp 5.000/rincian DKE. Layanan Penagihan Reguler sebesar Rp 5.000/rincian DKE. Biaya Administrasi Kliring Debet (Setoran Cek/BG): Rp 3.000. Biaya warkat debit (jika ada): Rp 1.000. Biaya pembatalan: Rp 5.000",
    },
  },
  ...
  // 5. BI-RTGS
  {
    ...
    details: {
      ...
      tarif:
        "JAM OPERASIONAL DAN TARIF BIAYA: 06.30-10.00 WIB: Rp 6.000, 10.00-14.00 WIB: Rp 15.000, 14.00-16.30 WIB: Rp 21.000. Minimal Nominal Transaksi: Rp 100.000.000",
    },
  },
  ...
  // 8. L/C (LETTER OF CREDIT)
  {
    ...
    details: {
      ...
      fitur:
        "Akad: wakalah bil ujrah (akad perwakilan dengan imbalan jasa). Pembayaran berbasis dokumen. Fee berupa ujrah transparan. Verifikasi Dokumen (Document Checking). Notifikasi Pembayaran.",
      tarif:
        "Biaya Pelayanan Impor dan Ekspor (mencakup berbagai jenis biaya untuk L/C advising, transfer/pengalihan, dan layanan lainnya sesuai dokumen)",
    },
  },

  // 9. GARANSI TA'AWUN (BANK GARANSI)
  {
    id: "garansi-taawun",
    title: "Garansi Ta'awun",
    ...
    details: {
      ...
      tarif:
        "Biaya Penerbitan Bank Garansi: Admin Rp 150.000, Komisi sesuai ketentuan yang berlaku. Biaya Administrasi (Bank Handling Fee): Rp 200.000. Bea Materai: Rp 10.000",
    },
  },

  // 10. SAFE DEPOSITE BOX (SDB)
  {
    id: "safe-deposite-box",
    title: "Safe Deposite Box (SDB)",
    desc: "Layanan penyimpanan barang berharga yang aman",
    definisi:
      "Safe Deposit Box (SDB) Syariah adalah layanan jasa penyewaan kotak penyimpanan aset berharga (seperti perhiasan, logam mulia, dan dokumen penting) yang memanfaatkan ruang khazanah bank dengan sistem keamanan canggih, yang diikat dengan akad Ijarah atau sewa-menyewa antara bank (sebagai pemilik aset yang disewakan) dan Nasabah (sebagai penyewa manfaat kotak) untuk memberikan perlindungan keamanan dan kerahasiaan maksimal terhadap harta Nasabah dari risiko pencurian atau bencana, sehingga Nasabah dapat menyimpan barang-barang tersebut dengan tenang dan sesuai prinsip syariah selama periode waktu yang disepakati, dengan membayar biaya sewa (Ujrah) tahunan di muka kepada bank. Aset hanya dapat diambil jika nasabah mengkonfirmasi dan datang langsung ke cabang membawa tanda kepemilikan SDB.",
    image:
      "https://images.unsplash.com/photo-1582139329536-e7284fece509?w=400&q=80",
    details: {
      syarat: [
        "Memiliki rekening di Bank Melasa Syariah",
        "Mengisi formulir permohonan penyewaan SDB",
        "Menyerahkan fotokopi KTP/identitas diri yang masih berlaku",
        "Menyerahkan fotokopi NPWP (jika ada)",
        "Menandatangani akad ijarah (sewa-menyewa)",
        "Membayar biaya sewa sesuai ukuran kotak yang dipilih",
      ],
      fitur:
        "Keamanan Maksimal: Brankas terlindungi dengan sistem keamanan berlapis. Privasi Terjamin: Hanya penyewa yang memiliki akses ke kotak. Ukuran Beragam: Tersedia berbagai ukuran sesuai kebutuhan. Akses Fleksibel: Dapat diakses selama jam operasional bank. Asuransi: Dapat diasuransikan untuk perlindungan tambahan.",
      tarif:
        "Biaya Sewa per Tahun: Ukuran Kecil Rp 500.000, Ukuran Sedang Rp 1.000.000, Ukuran Besar Rp 2.000.000. Deposit Kunci: Rp 500.000 (dikembalikan saat pengembalian kunci). Biaya Administrasi: Rp 100.000. Denda Keterlambatan: Rp 50.000 per bulan",
    },
  },

  // 11. BC CARD (JUAL BELI VALUTA ASING)
  {
    id: "bc-card",
    title: "BC Card (Jual Beli Valuta Asing)",
    desc: "Kartu pembiayaan berbasis syariah untuk transaksi valuta asing",
    definisi:
      "BC Card adalah kartu pembiayaan berbasis syariah yang diterbitkan oleh Bank Brilliant Core (BC). Kartu ini berfungsi serupa dengan kartu kredit konvensional, digunakan sebagai alat pembayaran untuk transaksi serta berfungsi seperti kartu kredit namun dijalankan sesuai prinsip syariah berdasarkan fatwa DSN MUI No. 54/DSN-MUI/X/2006. BC Card menggunakan tiga akad syariah yaitu Kafalah (penjaminan), Qardh (pinjaman), dan Ijarah (sewa jasa).",
    image:
      "https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=400&q=80",
    details: {
      syarat: [
        ...
        "Untuk transaksi bisnis: dokumen legal usaha (SIUP, NIB, NPWP, Akta Usaha)",
        "Mengisi formulir transaksi valas syariah",
        "Transaksi dilakukan tunai atau transfer langsung (spot), tidak boleh ditunda",
      ],
      fitur:
        "Transaksi jual beli valuta asing (valas) antar dua mata uang yang berbeda berdasarkan akad sharf secara tunai (spot). Kurs jual/beli transparan, mengikut pergerakan pasar. Dapat dilakukan melalui counter bank atau aplikasi mobile banking syariah. Hanya berlaku untuk tujuan syar'i, seperti: Keperluan perjalanan ke luar negeri, Pembayaran biaya pendidikan di luar negeri, Keperluan dagang internasional, Pembayaran biaya pendidikan di luar negeri. Mata uang yang dilayani: USD, SGD, EUR, JPY, AUD, SAR, dan lainnya.",
      tarif:
        "Biaya Administrasi Per transaksi: Rp 10.000 - Rp 25.000. Kurs Jual/Beli: Mengikuti Kurs Harian BSI Berdasarkan Update pada transaksi. Pajak Transaksi (jika berlaku): Sesuai Peraturan pemerintah. Mengacu ketentuan BI",
    },
  },
];

console.log("✅ feeBasedProducts loaded:", feeBasedProducts.length, "products");
