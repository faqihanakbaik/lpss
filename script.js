...
// Merge products from external files if available
if (typeof fundingProducts !== "undefined") {
  console.log(
    "✅ Loading funding products from external file:",
...
if (typeof feeBasedProducts !== "undefined") {
  console.log(
    "✅ Loading fee based products from external file:",
    feeBasedProducts.length,
    "products"
  );
}
if (typeof financingProducts !== "undefined") {
  console.log(
    "✅ Loading financing products from external file:",
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  setTimeout(() => {
    if (typeof calculateAngsuran === "function") {
      console.log("🔄 Running calculateAngsuran from DOMContentLoaded...");
      calculateAngsuran();
    }
  }, 100);

  // Ensure products are rendered (fallback)
  setTimeout(() => {
    const carousel = document.getElementById("productCarousel");
    if (carousel && carousel.children.length === 0) {
      console.log("⚠️ No products found, forcing render...");
...
const productData = {
  // Use external funding products if available, otherwise use default
  funding:
    typeof fundingProducts !== "undefined"
      ? fundingProducts
      : [
          {
            id: "tabungan-t-trip",
          ...
          },
          {
            ...
            details: {
              syarat: [
                ...
                "2. Mengisi dan menandatanganil formulir pembukaan rekening tabungan",
                "3. Melampirkan fotokopi KTP/paspor.",
                "4. Menyetorkan saldo awal minimal Rp100.000",
                "5. NPWP(jika ada)",
              ],
              fitur:
                "1. Setoran awal ringan 2. Kartu Debit dan Buku Tabungan 3. Mobile banking 4. e-chanel BMS Mobile, BNS net banking, notifikasi sms dan email 5. Akad Wadiah Yad Dhamanah",
              tarif:
                "1. Setoran awal Rp. 100.000 2. Biaya Administrasi GRATIS 3. Penutupan Rekening Rp. 20.000 4. Biaya Dormant Rp. 5.000 5. Biaya pengecekan saldo di ATM bank lain Rp 4.000 6. Biaya penggantian buku tabungan Rp. 5.000 7. Biaya pergantian Kartu ATM BNS Debit Rp 25.000 8. Transfer antar bank : Transfer Online Rp 6.500 BI FAST Rp 2.500 9. Biaya Penarikan Rp 2.500 di bawah Rp 5.000.000",
            },
          },
          {
            ...
            definisi:
              "Tabungan Prioritas Safwah iB adalah produk simpanan prioritas berakad Mudharabah Mutlaqah, secara eksklusif ditujukan untuk nasabah individu dengan saldo dana kelolaan besar dan frekuensi transaksi tinggi, dengan tujuan untuk memberikan layanan premium yang cepat, aman, bebas dari unsur riba, serta menawarkan imbal hasil berupa porsi bagi hasil dan reward berupa hibah yang lebih kompetitif dari Bank, di mana nasabah dapat melakukan pembukaan rekening kapan saja.",
            image:
              "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=400&q=80",
            details: {
              syarat: [
                "1.Saldo Akumulatif Minimum Rp. 300.000.000",
                "2. Mengisi dan menyetujui syarat layanan prioritas",
                "3.WNA (Paspor)/WNI (KTP)",
                "4.Tidak tecatat daftar Hitam di OJK",
                "5.Dana berasal dari sumber yang Halal",
                "6.Aktif bertransaksi di bank BMS Syariah",
              ],
              fitur:
                "• Kartu Shar-E Debit Prioritas • Mobile Banking • Limit transaksi yang lebih besar • Ruangan Khusus • M-Banking • Buku Tabungan • Layanan SMS Dan Notifikasi Gimail • Mendapatkan Merchendice hari special • Bagi Hasil Yang menarik yaitu 40%(nasabah) : 60%(bank)",
              tarif:
          ...
          },
          {
            ...
            details: {
              syarat: [
                ...
                "a. Mengajukan formulir aplikasi pembukaan rekening",
                "b. Mengisi formulir aplikasi pembukaan rekening",
                "c. Melakukan setoran awal minimal Rp1.000,-",
                "Melampirkan Kartu Identitas Warga Negara Indonesia:",
                "a. Elektronik Kartu Tanda Penduduk Orang Tua/Wali (E-KTP);",
                "b. Kartu Keluarga;",
                "c. Kartu Identitas Anak (KIA) atau Akta Kelahiran atau Kartu Pelajar;",
                "d. Nama dan Alamat Sekolah atau Pondok Pesantren/Madrasah.",
              ],
              fitur:
                "1. Mendapatkan Buku Tabungan. 2. Mendapatkan Kartu Debit. 3. Mendapatkan Sosialisasi Pengetahuan. 4. Setoran Awal Minimum. 5. Mendapatkan SMS dan Notifikasi",
              tarif:
                "1. Setoran Awal: Rp5.000, 2. Saldo Minimal: Rp10.000, 3. Setoran Minimal: Rp5.000, 4. Sms Notifikasi: All Provider. Fasilitas Kartu ATM. 5. Silver Batas Transfer Harian: On Us Rp 50.000.000,- Off Us Rp 20.000.000, 6. Batas Transfer Per Transaksi: On Us Rp 25.000.000,- Off Us Rp 10.000.000, 7. Batas Penarikan Harian di ATM: On Rp 5.000.000,- Off Us Rp 5.000.000,-",
            },
          },
          {
            id: "tabungan-tijarah",
            ...
            definisi:
              "Tabungan Tijarah iB dirancang untuk memudahkan transaksi bagi pelaku usaha, baik perorangan wiraswasta maupun non-perorangan (badan usaha), dilengkapi dengan fasilitas yang mendukung fleksibilitas transaksi bisnis serta sesuai prinsip syariah dengan menggunakan akad Mudharabah Mutlaqah dengan bagi hasil yang menarik, dan dapat melakukan pembukaan rekening ketika jam operasional, dengan syarat dan ketentuan yang mudah bagi wirasuaha dapat membantu untuk mengelola keuangan untuk bisnis nya.",
            image:
              "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=400&q=80",
            details: {
              syarat: [
                "1. UNTUK INDIVIDU MELAMPIRKAN KARTU IDENTITAS DIRI (KTP) DAN NPWP",
                "2. DOKUMEN TAMBAHAN UNTUK PERUSAHAAN (NON INDIVIDU) MELIPUTI KTP PEJABAT PERUSAHAAN YANG BERWENANG, AKTA PENDIRIAN PERUSAHAAN DAN PERUBAHAN TERAKHIR, NPWP, SIUP/TDP, NIB SERTA DOMISILI PERUSAHAAN",
                "3. MENGISI DAN MENANDATANGANI FORMULIR PEMBUKAAN REKENING SECARA LENGKAP DAN BENAR",
              ],
              fitur:
                "1. PEMBAYARAN BILL PAYMENT (LISTRIK, INTERNET, AIR, DAN TELEPON). 2. AKSES MOBILE BANKING APLIKASI TIJA-SYARIAH. 3. BUKU FISIK TABUNGAN. 4. KARTU DEBIT, TERSEDIA DUA PILIHAN JENIS KARTU ATM YAITU PLATINUM DAN DZAHABUN UNTUK NASABAH PERORANGAN SERTA ATM DZAHABUN UNTUK NON PERORANGAN. 5. BAGI HASIL YANG MENARIK UNTUK NASABAH 40% DAN BANK 60%.",
              tarif:
                "Setoran Awal Mininum: Rp 100.000,00.- Setoran Minimum Selanjutnya: Rp50.000,00. Saldo Minimum: Rp 500.000,00.- Biaya Penutupan Atau Pembukaan Rekening: Rp25.000,00.- Biaya Kartu Debit yang rusak/hilang: Rp25.000,00.- Biaya Penggantian Buku Tabungan yang Hilang: Rp25.000,00 Biaya Dormant: Rp 10.000",
            },
          },
          {
            ...
            details: {
              ...
              fitur:
                "Setoran awal: Rp.10.000. Setoran minimal: Rp.10.000. Fasilitas kartu ATM: Gold. Batas transfer harian: on us Rp. 75.000.000, off us Rp. 30.000.000. Setoran minimal: Rp.10.000,- Sms notifikasi: All provider. Batas transfer per transaksi: on us Rp. 25.000.000,- off us Rp. 10.000.000,- Batas penarikan harian di ATM: on us Rp. 10,000.000,- off us Rp. 5.000.000, Bagi Hasil yang menarik yaitu 40% untuk nasabah dan 60% untuk bank.",
              tarif:
  ...
  // Use external financing products if available, otherwise use default
  financing:
    typeof financingProducts !== "undefined"
      ? financingProducts
      : [
          {
            id: "gadai-emas",
          ...
          },
          {
            ...
            desc: "Pembiayaan modal usaha untuk UMKM",
            definisi:
              "Pembiayaan Usaha Rakyat Syariah adalah produk pembiayaan dengan akad Murabahah atau Musyarakah yang dirancang khusus untuk membantu pelaku UMKM mengembangkan usahanya dengan modal kerja atau investasi, dengan proses mudah dan margin kompetitif.",
            image:
            ...
            details: {
              syarat: [
                ...
                "Berusia minimal 21 tahun atau telah menikah",
                "Usia maksimal saat pelunasan adalah 60 tahun",
                "Melengkapi dokumen permohonan dan legalitas usaha",
              ],
              fitur:
                "Plafon pembiayaan hingga Rp 500 juta. Jangka waktu pembiayaan hingga 5 tahun. Akad Murabahah atau Musyarakah. Margin kompetitif dan transparan. Proses persetujuan cepat. Dapat digunakan untuk modal kerja atau investasi usaha. Agunan: Sertifikat tanah/bangunan atau BPKB kendaraan.",
              tarif:
                "Biaya Administrasi: 1% dari plafon pembiayaan. Biaya Notaris: Sesuai kebijakan bank. Biaya Materai: Bervariasi sesuai jumlah dokumen. Biaya Appraisal: Rp 300.000 - Rp 500.000. Biaya Asuransi: Sesuai tarif perusahaan asuransi syariah. Margin: 10-14% per tahun (tergantung profil risiko). Biaya Ta'widh: Rp 50.000 per keterlambatan.",
            },
          },
        ],
  // Use external fee based products if available, otherwise use default
  fee_based:
    typeof feeBasedProducts !== "undefined"
      ? feeBasedProducts
      : [
          {
            id: "al-qardh-card",
...
function initNavigation() {
  ...
  // Force border-radius on indicator
  if (indicator) {
...
function initProductCarousel() {
  ...
  if (!carousel) {
    console.error("❌ productCarousel element not found!");
    return;
  }
  ...
  tabBtns.forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      console.log("Tab clicked, category:", currentCategory);
      renderProducts();
  ...
  // Initial render
  try {
    console.log("📦 Calling initial renderProducts()...");
    renderProducts();
  } catch (error) {
    console.error("❌ Error in initial renderProducts():", error);
  }
}

function renderProducts() {
  console.log("🎨 renderProducts() called for category:", currentCategory);

  const carousel = document.getElementById("productCarousel");
  if (!carousel) {
    console.error("❌ productCarousel element not found in renderProducts!");
    return;
  }

  const products = productData[currentCategory];
  if (!products) {
    console.error("❌ No products found for category:", currentCategory);
...
function initFinancingCalculator() {
  ...
  if (!jumlahInput) {
    console.log(
      "❌ initFinancingCalculator: jumlahPinjaman element not found!"
    );
    return;
  }

  console.log(
    "✅ initFinancingCalculator: Elements found, setting up listeners..."
  );
...
function calculateAngsuran() {
  console.log("🔢 calculateAngsuran() called");
  ...
  console.log("Input values:", { hargaTotal, jangka, margin, dpPersen });
