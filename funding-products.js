...
// Total: 16 Products (Complete from prodduukks.txt)
...
const fundingProducts = [
  ...
  ,{
    ...
    definisi: "Tabungan Prioritas Safwah iB adalah produk simpanan prioritas berakad Mudharabah Mutlaqah, secara eksklusif ditujukan untuk nasabah individu dengan saldo dana kelolaan besar dan frekuensi transaksi tinggi, dengan tujuan untuk memberikan pelayanan premium yang cepat, aman, bebas dari unsur riba, serta menawarkan imbal hasil berupa porsi bagi hasil dan reward berupa hibah yang lebih kompetitif dari Bank.",
    ...
    details: {
      ...
      fitur: "Kartu Shar-E Debit Prioritas. Mobile Banking. Limit transaksi yang lebih besar. Ruangan Khusus. M-Banking. Buku Tabungan. Layanan SMS Dan Notifikasi. Gimal. Mendapatkan Merchendice hari special. Bagi Hasil Yang menarik yaitu 40%(nasabah) : 60%(bank).",
      tarif: "Setoran Awal: Rp. 50.000.000 - Rp 100.000.000. Saldo Minimum Mengendap: Rp. 500.000.000. Biaya Administrasi Kartu Debit: Rp 20.000 per bulan. Biaya Penutupan Rekening: Rp. 100.000. Biaya Rekening Dormant: Rp. 10.000"
    }
  },
  ...
  ,{
    ...
    definisi: "Tabungan SimPel adalah Simpanan Pelajar, yaitu tabungan khusus untuk siswa dari PAUD hingga SMA/sederajat. Tujuannya adalah untuk mendorong budaya menabung sejak dini melalui persyaratan yang mudah dan sederhana, serta fitur yang menarik untuk edukasi dan inklusi keuangan. Menggunakan akad Wadiah Yad Dhamanah, penarikan dapat dilakukan kapan saja ketika jam operasional.",
    ...
    details: {
      ...
      fitur: "Mendapatkan Buku Tabungan. Mendapatkan Kartu Debit. Mendapatkan Sosialisasi Pengetahuan. Setoran Awal Minimum. Mendapatkan SMS dan Notifikasi.",
      tarif: "Setoran Awal: Rp5.000. Saldo Minimal: Rp10.000. Setoran Minimal: Rp5.000. Sms Notifikasi: All Provider. Fasilitas Kartu ATM Silver. Batas Transfer Harian: On Us Rp 50.000.000, Off Us Rp 20.000.000. Batas Transfer Per Transaksi: On Us Rp 25.000.000, Off Us Rp 10.000.000. Batas Penarikan Harian di ATM: On Us Rp 5.000.000, Off Us Rp 5.000.000"
    }
  },
  ...
  // 6. TABUNGAN TIJARAH iB
  {
    ...
    definisi: "Tabungan Tijarah iB dirancang untuk memudahkan transaksi bagi pelaku usaha, baik perorangan wiraswasta maupun non-perorangan (badan usaha), dilengkapi dengan fasilitas yang mendukung fleksibilitas transaksi bisnis serta sesuai prinsip syariah dengan menggunakan akad Mudharabah Mutlaqah dengan bagi hasil yang menarik.",
    ...
    details: {
      ...
      fitur: "Pembayaran Bill Payment (listrik, internet, air, dan telepon). Akses Mobile Banking aplikasi Tija-Syariah. Buku Fisik Tabungan. Kartu Debit, tersedia dua pilihan jenis kartu ATM yaitu Platinum dan Dzahabun untuk nasabah perorangan serta ATM Dzahabun untuk non perorangan. Bagi Hasil yang menarik untuk nasabah 40% dan Bank 60%.",
      tarif: "Setoran Awal Minimum: Rp 100.000. Setoran Minimum Selanjutnya: Rp50.000. Saldo Minimum: Rp 500.000. Biaya Penutupan Atau Pembukaan Rekening: Rp25.000. Biaya Kartu Debit yang rusak/hilang: Rp25.000. Biaya Penggantian Buku Tabungan yang Hilang: Rp25.000. Biaya Dormant: Rp 10.000"
    }
  }
  ...
  ,{
    ...
    definisi: "Tabungan iB Mulia Pensiunan Syariah adalah produk simpanan berjangka yang menggunakan akad Mudharabah Mutlaqah diperuntukan bagi nasabah perorangan atau karyawan perusahaan yang berkeinginan mempersiapkan jaminan finansial untuk masa hari tua atau purnabakti dengan tujuan agar nasabah dapat mempersiapkan dananya di hari tua ketika sudah memasuki masa pensiun di mana dana yang terkumpul hanya dapat dicairkan pada saat nasabah mencapai usia pensiun atau batas waktu yang disepakati.",
  ...
  ,{
    ...
    definisi: "Tabungan Emas-slahah dengan Akad Wadhi'ah Yad Dhamanah adalah layanan simpanan dalam bentuk saldo emas digital atau fisik, kepada nasabah/masyarakat umum yang ingin berinvestasi dalam emas dengan cara mencicil atau menabung secara rutin, emas tersebut dapat nasabah lakukan pencairan atau penarikan kapan saja, dengan datang langsung ke kantor cabang.",
    ...
    details: {
      ...
      fitur: "Setoran ringan. BMS Mobile Banking. Fasilitas E-Mas untuk melihat Saldo. Buku Tabungan. Investasi Emas Syariah. Auto Debet Infaq.",
      tarif: "Setoran Awal: Rp50.000. Minimal Setoran Wajib Auto Debet: Rp50.000. Minimal Setoran Manual/Top Up: Rp10.000. Saldo Minimum: Rp10.000. Minimal target dana (hold): Rp600.000. Penarikan darurat: Rp50.000. Penutupan rekening: Rp50.000. Ganti buku karena rusak: Rp15.000"
    }
  },
  ...
  // 10. TABUNGAN EDUDREAM iB
  {
    ...
    details: {
      ...
      fitur: "Setoran ringan dan bebas biaya administrasi. Buku Tabungan. BLS Mobile Banking. Notifikasi dan sms. Beasiswa.",
      tarif: "Setoran Awal: Rp 50.000. Setoran Rutin Minimum per Bulan: Rp 20.000. Biaya Administrasi: Gratis. Biaya Penutupan Rekening: Rp 10.000"
    }
  },
  ...
  // 11. TABUNGAN GLOBALUNITY iB
  {
    ...
    details: {
      ...
      tarif: "Setoran Awal Minimum: Rp 4.800.000 (setara USD 300). Saldo Minimum: Rp3.200.000 (setara USD 200). Administrasi Bulanan Gratis, jika saldo ≥USD 200. Biaya Saldo di Bawah Minimum USD 2 per bulan (jika saldo < USD 200). Biaya Penutupan Rekening USD 5. Transfer Antar Negara Mengikuti biaya bank koresponden (sekitar USD 10–15). Tarik Tunai di ATM Luar Negeri Gratis di jaringan Bank Nusantara Syariah dan mitra global"
    }
  }
  ...
  // 13. GIRO PLATINUM iB
  {
    ...
    definisi: "Giro Utama Sahanah iB adalah produk simpanan syariah Bank Sahanah Syariah untuk perorangan atau badan usaha yang memungkinkan kemudahan transaksi karena dapat dicairkan kapan saja dengan cek/bilyet giro. Keamanan, dan Kepastian Manfaat.",
  ...
  // 14. DEPOSITO ON CALL iB AMANAH
  {
    ...
    definisi: "Deposito On Call dengan akad Mudharabah Mutlaqah adalah produk simpanan investasi berjangka pendek yang menggunakan akad Mudharabah Mutlaqah, Nasabah dapat memperoleh bagi hasil yang optimal, kompetitif, dan dapat dinegosiasikan dengan Bank yang akan dibayarkan setelah jangka waktu penempatan yang singkat tersebut berakhir, yang mekanismenya disepakati dan diadministrasikan langsung di kantor Bank. Pencairan disertai pemberitahuan sebelumnya (on call) minimal 3 hari kerja.",
    image: "https://images.unsplash.com/photo-1633158829585-23ba8f7c8caf?w=400&q=80",
    details: {
      syarat: [
      ...
      fitur: "Penempatan Deposito Rp 1.000.000.000. Tenor/Bagi Hasil Nisbah: 1-7 Hari 25%, 8-14 Hari 30%, 15-21 Hari 35%, 22-29 Hari 40%. Penempatan Bagi Hasil: Giro atau Tabungan. Status Perpanjangan: Non ARO. Bukti Kepemilikan: Bilyet Deposito.",
  ...
  ,{
    ...
    details: {
      ...
      fitur: "Pokok Deposito diperpanjang otomatis saat jatuh tempo (ARO). Pokok dan bagi hasil Deposito diperpanjang otomatis saat jatuh tempo (ARO Kapitalisir). Deposito Cair saat jatuh tempo (Non ARO). Fitur Zakat atau Non Zakat. Jangka waktu: 1, 3, 6, dan 12 bulan.",
      tarif: "Setoran Awal: Rp 5.000.000. Biaya Penutupan Rp. 30.000 Bila terjadi perubahan biaya akan diinformasikan melalui media yang dianggap cukup oleh Bank. Biaya Pajak 20%. Bea meterai pada advis dan atau biaya lainnya jika ada sesuai dengan regulasi atau ketentuan yang berlaku."
    }
  },
  ...
  // 16. REKSA DANA SYARIAH
  {
    ...
    details: {
      ...
      fitur: "Berbasis prinsip syariah. Diawasi Dewan Pengawas Syariah (DPS). Investasi pada Efek Syariah. Cleansing (Pembersihan Pendapatan Non-Halal).",
      tarif: "Biaya pengelolaan: Selama berinvestasi. Biaya pengalihan: Saat ganti produk. Biaya penjualan unit: Saat mencairkan dana. Biaya pembelian unit: Saat membeli unit. Minimum transaksi awal: Rp 1.000.000. Minimum Top Up: Rp 100.000"
    }
  }
];
